...
def index(request):
    context = {
        ...
        'body_subtitle': 'Uma landing page é como a vitrine virtual do seu negócio. É uma página da web criada bos medida para você. Imagine-a como a porta de entrada direta para o que sua empresa oferece de melhor. Permita que seus clientes o encontrem com os nossos serviços.',
        ...
        'item2_content': 'Com um design profissional e informações claras, transmitimos confiança, destacando sua marca de maneira sólida e confiável. Nossa área de depoimentos deixa claro que outros clientes já apreciam seu trabalho.',
