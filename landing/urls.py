...
from .views import Homepage, BaseCardapioSimples, SejaNossoCliente, AJRCutelaria, set_visitas, set_demo_view, DemoView
...
urlpatterns = [
    ...
    path('', SejaNossoCliente.as_view(), name='index'),
