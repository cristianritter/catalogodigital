...
class LandingPage(Page):
    ...
    lista_items = models.TextField(default='{}', max_length=600,  help_text='Seção de lista da página. Dict no formato {"Título da lista": ["item1","item2",...]')
    colunas_items = models.TextField(default='{}', help_text='SEeão de colunas da página. Dict no formato {"Título1":"Conteúdo1","Título2":"Conteúdo2"},...')
