...
class LandingPageData(models.Model):
    class Meta:
        verbose_name = 'Registro de Landing Pages'
       # verbose_name_plural = 'Cadastrar, Editar ou Remover'
    #Dados técnicos
    ...
    nomes_arquivos_imagens = models.CharField(blank=True, max_length=300, help_text='Links para os arquivos, separados por virgula')
    ...
    lista_titulo = models.CharField(blank=True, max_length=50, help_text='Pode ser usado o título: "Produtos e Serviços"')
    ...
    numeros_telefone = models.CharField(blank=True, max_length=50, help_text='Digite os números de telefone')
    ...
    horario_atendimento = models.CharField(blank=True, max_length=100, help_text='Digite o horário de atendimento')
